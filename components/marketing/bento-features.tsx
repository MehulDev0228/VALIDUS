    ...
    >
      <div className="mx-auto max-w-[1320px] px-6 md:px-10">
        ...
        >
          ...
          <h2 className="marketing-title mt-4 font-display">What you get, every run.</h2>
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 md:grid-cols-12 md:gap-5">
          ...
          >
            <div className="flex h-full min-h-[320px] flex-col rounded-xl border border-white/[0.07] bg-ink-1 p-8 md:p-10">
              <span className="font-display text-sm font-semibold text-bone-2">01</span>
              <h3 className="font-display mt-4 text-2xl font-semibold tracking-tight text-bone-0 md:text-3xl">
                Seven angles
              </h3>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-8%" }}
            transition={{ duration: 0.58, delay: 0.06, ease: ease.editorial }}
            className="md:col-span-5"
          >
            <div className="flex h-full min-h-[240px] flex-col rounded-xl border border-ember/20 bg-gradient-to-b from-ember/12 via-ink-1 to-ink-1 p-8">
              <p className="doc-kicker text-ember/90">Verdict</p>
              <h3 className="font-display mt-4 text-xl font-semibold text-bone-0">BUILD · PIVOT · KILL</h3>
          ...
          >
            <div className="rounded-xl border border-dashed border-white/[0.14] bg-transparent p-8 md:p-10">
              <p className="doc-kicker text-ember/90">Tensions</p>
              <h3 className="font-display mt-4 text-xl font-semibold text-bone-0">Disagreement stays visible</h3>
              <p className="marketing-body mt-3">
                Where angles read the same sentence differently, both sides stay on the page.
              </p>
              <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="rounded-lg border border-white/[0.06] bg-ink-0/50 p-4">
          ...
          <motion.div
            ...
            className="md:col-span-5"
          >
            <div className="h-full rounded-xl border border-white/[0.07] bg-ink-1 p-8">
              <p className="doc-kicker text-ember/90">48-hour plan</p>
              <h3 className="font-display mt-4 text-xl font-semibold text-bone-0">Cheap tests first</h3>
